...
$sql="SELECT maintain FROM  6btb_settings ";
...
if($result_signin['f_sign_in']==0)
{
     session_start();
       ...
       $phone= $result_signin['users_phone'];
        ...
        $_SESSION['username_for_otp'] = $username;
    ...
    [
      ...
      'to' => $phone,
      'from' => 'Paydae',
      'text' => 'Your OTP is-'.$five_digit_random_number.'Valid for 5 minute' 
    ]
);
...
//echo $response;
  ...
  foreach ( $decoded_response['messages'] as $message ) {
      if ($message['status'] == 0) {
          ...
          $up_date = mysql_query("update users set otp = '$five_digit_random_number',otp_time='$date' where users_name = '$username' and users_phone='$phone'");
