			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue"> register</h3>
...
<?php
		$i = 1;
$total="";
$select = select("*",$report_table,"WHERE report_reg_bonus 	 IS NOT NULL");
while($sl_row = mysql_fetch_array($select))
{		
if(!empty($sl_row['report_reg_bonus'])) {		
?>											
...
<td><?php echo $sl_row['report_reg_bonus'];?></td>
<td><? echo $total=$total +$sl_row['report_reg_bonus'];  ?></td>
