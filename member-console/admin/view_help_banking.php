				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">View Help & Information</li>
						</ul><!-- /.breadcrumb -->
...
<div class="card">
                     ...
                     <div class="card-body">
                      ...
                      if(isset($_REQUEST['id'])) {
						  ...
						  while($users_row = mysqli_fetch_array($users_data))
						  {
							  ...
							  $users_donation = number_format($users_row['users_donation'],2);
						  }
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        <thead>
                          ...
                          <tr>
                              <td>Id</td>
                              <td><?php echo $single_row['auto_id'];?></td>
                          </tr>
                          <tr>
                              <td>Transaction Id</td>
                              <td><?php echo $single_row['id'];?></td>
                          </tr>
                          <tr>
                              <td>User Name</td>
                          ...
                          <tr>
                              <td>Last Name</td>
                              <td><?php echo $single_row['lastname'];?></td>
                          </tr>
                          <tr>
                              <td>Bank</td>
                              <td><?php echo $single_row['bank'];?></td>
                          </tr>
                          <tr>
                              <td>Amount</td>
                              <td><?php echo $users_donation;?></td>
                          </tr>
                          
                          <tr>
                              <th colspan="2">Banking Information</th>
                          </tr>
                          <tr>
                              <td>Bank Name</td>
                              <td><?php echo $single_row['bank_name'];?></td>
                          </tr>
                          <tr>
                              <td>Account Holder</td>
                              <td><?php echo $single_row['acount_holder'];?></td>
                          </tr>
                          <tr>
                              <td>Account Number</td>
                              <td><?php echo $single_row['account_number'];?></td>
                          </tr>
                          <tr>
                              <td>Account Type</td>
                              <td><?php echo $single_row['account_type'];?></td>
                          </tr>
                          <tr>
                              <td>Branch</td>
                              <td><?php echo $single_row['branch'];?></td>
                          </tr>
                          <tr>
                              <td>Branch Code</td>
                              <td><?php echo $single_row['branch_code'];?></td>
                          </tr>
                        </tr>
                  </thead>
                        </table>
