...
<?php
		$i = 1;
$total="";
$select = select("*",$report_table,"");
while($sl_row = mysql_fetch_array($select))
{		
if(!empty($sl_row['report_testimonial'])) {		
?>											
...
<td><?php echo $sl_row['report_testimonial'];?></td>
<td><? echo $total=$total +$sl_row['report_testimonial'];  ?></td>
