...
$users_table."_address" => $_REQUEST['address'],
$users_table."_donation" => $_REQUEST['donation_amount'],
...
?>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Donation Amount  </label>

										<div class="col-sm-9">
<?php /*?><textarea name="address" id="content" class="col-xs-8">
<?php if(isset($_REQUEST['edit'])){ echo $row['users_donation']; } else { echo '';}  ?>
</textarea><?php */?>
<input type="text" name="donation_amount" id="title "  class="form-control"
value="<?php if(isset($_REQUEST['edit'])){ echo $row['users_donation']; } else { echo "";} ?>">
										</div>
									</div>						
			<div class="form-group">
