...
$result = mysql_query("SELECT * FROM  users where users_email = '$email'");
...
$re = mysql_query("update users set users_pass = '$newpassword' where users_email = '$email'");
if($re)
{
...
<head>
<meta charset="utf-8" />
<title>Forgot Password Request - Mylifestylewealth</title>
