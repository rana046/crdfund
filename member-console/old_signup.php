...
$query=mysql_query("insert into  users(users_date,users_name,users_pass,users_fullname,users_address,users_email,users_reff_name,users_phone,users_country,users_bonus,users_package,users_status,users_donation,users_ref_date)
		   values('$date','$username','$password','$name','$address','$email','$ref','$mobile','$country','$bonusper','$package','1','$donation','$date')");
...
<head>
    ...
    <meta name="author" content="oxedes12" >
