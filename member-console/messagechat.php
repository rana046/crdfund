...
include 'header.php';
echo '<link rel="stylesheet" type="text/css" media="all" href="'.$baseurl.'php-emoji-master/lib/emoji.css" />';
...
width: 700px;											
											...
											{
   background-image: "assets/img/audio.png";											
											}
...
<label for="uploadimage_<?php echo $id;?>"> <span class=""><i class="md md-photo"></i></span></label>
  ...
  <li><button type="button" class="hash_tag_<?php echo  $id;?>"> ADD space </button></li>
</ul>										
<style type="text/css">
.hash_tag_<?php echo  $id;?>
{
margin-left: 12px;
}
.message_<?php echo  $id;?>
{
margin-left: 0px;
}
</style>
 ...
 <form>
  ...
  <div class="messagebox_<?php echo  $id;?>" contenteditable="">
    <div class=" textarea<?php echo  $id;?> message_<?php echo  $id;?>" contenteditable="">
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.2/jquery.min.js"></script>
 ...
 $(document).ready(function(){
 	...
 	$(".hash_tag_<?php echo  $id;?>").click(function(){

 	var valueh	= $(".message_<?php echo  $id;?>").css("margin-left");
//alert(valueh);
$(".message_<?php echo  $id;?>").css("margin-left","100px");
});
...
//$('.result').append(response.html)
      ...
      $(function () {
        ...
        //	alert();
$(".textarea<?php echo  $id;?>").addClass("contentdiv");
$(".contentdiv").removeClass("textarea<?php echo  $id;?>");
$(".contentdiv").removeClass("message_<?php echo  $id;?>");
$(".contentdiv").removeAttr("contenteditable");
$("emoji-outer ").removeAttr("contenteditable");
$("emoji-inner ").removeAttr("contenteditable");


           var string= $(".messagebox_<?php echo  $id;?>").html();
           
           var user =   "<?php echo  $id;?>";
alert(string);
             $(".message_<?php echo  $id;?>").css("margin-left","0px");
          $.ajax({
            type: 'post',
            url: 'ajax.php',
            ...
            //alert(res);
             ...
             $(".contentdiv").addClass("newclassco");
             $(".newclassco").removeClass("contentdiv");
             $(".newclassco").addClass("textarea<?php echo  $id;?>");
             $(".newclassco").addClass("message_<?php echo  $id;?>");
             $(".newclassco").addAttr("contenteditable");
...
//alert(myArray);
 var htmlc='<span  contenteditable="" class="emoji-outer emoji-sizer"><span contenteditable="" class="'+attrb+'"></span></span>';
   $(".message_<?php echo  $id;?>").append(htmlc);
});
</script>				
<? }
?>
