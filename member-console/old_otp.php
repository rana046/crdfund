...
<div class='alert alert-danger'>
     ...
     $_SESSION['username']=$_SESSION['username_for_otp'];$t='0000-00-00 00:00:00';
    $username= $_SESSION['username_for_otp'];
    // echo $sql="update users set otp = '',otp_time='$t',f_sign_in=1 where users_name = '$username'";
    
     
     $up_date = mysql_query("update users set otp = '',otp_time='$t' where users_name = '$username'"); 
  ...
  <div class="container aside-xl" style="    width: 100%;"> <a class="navbar-brand block" href="index.php"></a>
    <section class="m-b-lg">
      <header class="wrapper text-center">
       <strong>Please write the OTP </strong> 
       </header>
