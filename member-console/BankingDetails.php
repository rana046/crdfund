...
<head>
    ...
    <title>Banking Details - paydaeco</title>
  ...
  <div class="container-fluid">
    <div class="navbar-header pull-left">
      ...
      <ul class="breadcrumb">
        ...
        <li ng-bind="pageTitle" class="active ng-binding">Banking Details</li>
      </ul>
    </div>
...
<div class="card">
    ...
    <?php if(isset($_POST['donate_amount']))
    {
        ?>
    
    <form class="" action="PaymentMethodGateway.php?id=<?php echo $don_id;?>" method="post">
        <div class="table-responsive white custom_change_code_form">
          <div class="row">
              <div class="col-md-4">
                  <p><b>Total Donation Needed:</b></p>
              </div>                  
              <div class="col-md-8">                  
                  <?php 
                  
                  $total_donation_amount = $_POST['total_donation_amount'];
                  echo "<p>".number_format($total_donation_amount,2)."</p>";
                ?>
              </div>
          </div>
            <div class="row">
              ...
              <div class="col-md-8">                  
                  ...
                  echo "<p>".number_format($donate_amount,2)."</p>";
                ?>
              </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                $q="SELECT * FROM  packages WHERE packages_id = '".$user_package."'"; 
                $package_data = mysql_query($q);
                while($package_row = mysql_fetch_array($package_data))
                { 
                    $package_name = $package_row['packages_packages'];
                    $package_currency = $package_row['packages_currency'];
                     echo "<p>".$package_name." (".$package_row['packages_price'].$package_currency." - ".$package_row['packages_price1'].$package_currency.")</p>";
                }
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                  ...
                  <input type="button" onClick="javascript:location.href='ReservedPayments.php?id=<?php echo $don_id;?>'" value="BACK" class="btn btn-primary" style="background:#3C8DBC;">
